...
class Login extends React.Component {
  ...
  render() {
    return (
      <Grid container>
        <Grid item xs={7}>
          <img className="image" alt="foodImage" src='https://www.thespruceeats.com/thmb/ykAtjVYdziYq9UXdpo8y-l53ZbA=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/dukboki-korean-street-food-2118907-hero-01-285213c2e8a2494f852ccdea2b5eddd9.jpg' />
        </Grid>
        <Grid item xs={5}>
